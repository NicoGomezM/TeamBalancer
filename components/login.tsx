  ...
  const handleLogin = () => {
    if (selectedGroup && selectedPlayer) {
      ...
      if (selectedPlayerData) {
        // Guardar información completa del jugador en el contexto
        login(selectedGroup, selectedPlayerData.name, {
          id: selectedPlayerData.id,
          nickname: selectedPlayerData.nickname,
        ...
        <CardContent className="p-8 space-y-6">
          ...
          {selectedGroup && players.length > 0 && (
            <div className="space-y-2">
              <Label htmlFor="player-select" className="text-lg font-semibold text-gray-700">
                Selecciona tu Jugador (Quien sos? 🤨)   
              </Label>
          ...
          <div className="mt-4 text-center">
            <a
              ...
              className="text-xs text-gray-400 hover:text-blue-600 transition-colors duration-200 flex items-center justify-center gap-1"
            >
